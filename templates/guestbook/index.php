    ...
    <div class="row g-4 align-items-center">
        <div class="col-lg-7">            
            ...
            <div class="d-flex flex-wrap gap-2">
                <!--<a href="#form" class="btn btn-bengalis">Laisser un message</a>
                <a href="#messages" class="btn btn-outline-bengalis">Lire les messages</a>-->
            </div>
        </div>
        <div class="col-lg-5">
            <div class="royal-card h-100">
                <div class="royal-card-mark">U</div>
                <div class="royal-card-body">
                     <p class="hero-text mt-4">
                        n petit mot, un souvenir de concert, une émotion... Partagez avec nous votre expérience avec le Choeur Royal Les Bengalis de Liège. 
                        Votre message sera validé avant publication. Merci pour votre soutien et votre enthousiasme !
                    </p>
                </div>
            </div>
        </div>
...
<div class="row g-4">
    <div class="col-lg-7" id="messages">
        <div class="card app-card shadow-soft border-0 h-100">
    ...
    <div class="col-lg-5" id="form">
        <div class="card app-card shadow-soft border-0 sticky-lg-top form-card">
            <div class="card-body p-4">
                <h2 class="h4 app-section-title mb-2">Signer le livre d'or</h2>
                <p class="app-muted mb-2">Votre message sera validé avant publication.</p>
                ...
                <form method="post" action="?action=submit_entry">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control app-input app-textarea" id="message" name="message" rows="7" required maxlength="3000"></textarea>
                    </div>
                    ...
                    <button type="submit" class="btn btn-bengalis w-100 fw-semibold">Envoyer le message</button>
                </form>
            </div>
        </div>
    </div>
